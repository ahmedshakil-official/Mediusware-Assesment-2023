...
class ProductFilter(django_filters.FilterSet):
    ...
    variant = django_filters.CharFilter(field_name='productvariant__variant_title', lookup_expr='icontains', label='Variant contains')
    price_from = django_filters.NumberFilter(field_name='productvariantprice__price', lookup_expr='gte', label='Price from')
